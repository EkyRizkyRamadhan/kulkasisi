                ...
                <div class="lg:col-span-1 space-y-6">
                    <div class="bg-gray-900 rounded-3xl border border-gray-800 p-6 shadow-xl">
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <a href="{{ route('recipes.edit', $recipe->id) }}" class="shrink-0 bg-gray-950 hover:bg-indigo-600/20 border border-gray-700 hover:border-indigo-500 text-gray-400 hover:text-indigo-400 p-2 rounded-xl transition duration-300">
